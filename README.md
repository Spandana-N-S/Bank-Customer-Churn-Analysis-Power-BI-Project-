...
Dataset
This dataset contains 9,894 rows and 14 columns namely; Customer ID, credit score, country, gender, age, tenure, balance, credit card status (1 for owned and 0 for not owned), activity status(1 for active and 0 for inactive), churn status(1 for churned and 0 for not churned), products(product types 1,2,3,4), age groups(<20, >71, 21-30, 31-40, 41-50, 51-60, 61-70), credit scores(<=400, >=801, 410-500, 501-600, 601-700, 701-800), acct balance( >200k, 0,100k-200k, 10k-100k, 1k-10k)
